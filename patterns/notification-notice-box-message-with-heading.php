...
$content = <<<PATTERN
<!-- wp:group {"style":{"color":{"background":"#ffdb4f"},"spacing":{"padding":{"top":"1px","right":"1px","bottom":"1px","left":"1px"},"blockGap":"0px"}},"layout":{"type":"constrained","justifyContent":"center"}} -->
...
<!-- wp:group {"style":{"color":{"background":"#fffbf2","text":"#736b4c"},"border":{"style":"solid","width":"1px"},"spacing":{"padding":{"top":"20px","right":"20px","bottom":"20px","left":"20px"},"margin":{"top":"1px"}},"elements":{"link":{"color":{"text":"#736b4c"}}}},"borderColor":"white","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color has-white-border-color has-text-color has-background has-link-color" style="border-style:solid;border-width:1px;color:#736b4c;background-color:#fffbf2;margin-top:1px;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px"><!-- wp:list {"ordered":true,"className":""} -->
<ol><!-- wp:list-item -->
<li>Message one.</li>
<!-- /wp:list-item -->
...
return array(
	'title'      => __( 'Notice Box Message with Heading', 'easy-themes-striking-block-patterns' ),
	'slug'       => 'notice-box-with-heading',
